...
//
//            DEFAULT_COVERAGE_FILE_PATH = getContext().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS) + "/coverage.ec";
...
//        }
    ...
    public void onStart() {
        ...
        activity.registerReceiver(broadcast, new IntentFilter("rohit.reddy.EndEmmaBroadcast"));
